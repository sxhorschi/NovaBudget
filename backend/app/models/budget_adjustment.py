...
class BudgetAdjustment(UUIDPrimaryKeyMixin, Base):
    ...
    Each row represents a single, auditable change to a department's budget
    ...
    # relationships
    department: Mapped[Department] = relationship(back_populates="budget_adjustments")

    def __repr__(self) -> str:
        return (
            f"<BudgetAdjustment id={self.id} department_id={self.department_id} "
