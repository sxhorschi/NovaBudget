...
export const mockDepartments: Department[] = [
  { id: 1, facility_id: 1, name: 'Assembly', budget_total: 3_800_000 },
  { id: 2, facility_id: 1, name: 'Testing', budget_total: 1_500_000 },
  { id: 3, facility_id: 1, name: 'Intralogistics', budget_total: 700_000 },
  { id: 4, facility_id: 1, name: 'Building & Infrastructure', budget_total: 1_200_000 },
  { id: 5, facility_id: 1, name: 'Prototyping Lab', budget_total: 500_000 },
];
...
export const mockWorkAreas: WorkArea[] = [
  // Assembly (Dept 1)
  { id: 1, department_id: 1, name: 'Chassis Assembly' },
  { id: 2, department_id: 1, name: 'Drivetrain Station' },
  { id: 3, department_id: 1, name: 'Battery Pack Line' },
  { id: 4, department_id: 1, name: 'Final Assembly & Marriage' },
  { id: 5, department_id: 1, name: 'Rework & Touch-Up Bay' },
  // Testing (Dept 2)
  { id: 6, department_id: 2, name: 'End-of-Line Testing' },
  { id: 7, department_id: 2, name: 'Environmental Chamber' },
  { id: 8, department_id: 2, name: 'NVH & Vibration Lab' },
  { id: 9, department_id: 2, name: 'High-Voltage Safety Test' },
  // Intralogistics (Dept 3)
  { id: 10, department_id: 3, name: 'Goods-In & Receiving' },
  { id: 11, department_id: 3, name: 'Warehouse & Staging' },
  { id: 12, department_id: 3, name: 'AGV & Internal Transport' },
  { id: 13, department_id: 3, name: 'Shipping & Packaging' },
  // Building & Infrastructure (Dept 4)
  { id: 14, department_id: 4, name: 'Electrical Distribution' },
  { id: 15, department_id: 4, name: 'HVAC & Climate Control' },
  { id: 16, department_id: 4, name: 'Safety & Fire Protection' },
  { id: 17, department_id: 4, name: 'Flooring & Structural' },
  // Prototyping Lab (Dept 5)
  { id: 18, department_id: 5, name: 'CNC & Machining Center' },
  { id: 19, department_id: 5, name: 'Additive Manufacturing' },
  { id: 20, department_id: 5, name: 'Metrology & Inspection' },
];
...
export const mockCostItems: CostItem[] = [
  ...
  {
    id: 1, work_area_id: 1, description: 'Automated Torque Station T-400 (4-Spindle)',
  ...
  {
    id: 7, work_area_id: 2, description: 'E-Motor Assembly Press HPP-250 (250kN)',
  ...
  {
    id: 12, work_area_id: 3, description: 'Battery Module Press-Fit Unit BPF-200',
  ...
  {
    id: 14, work_area_id: 3, description: 'Battery Pack Leak Test Station (Helium)',
  ...
  {
    id: 15, work_area_id: 3, description: 'HV Busbar Welding Cell (Laser)',
  ...
  {
    id: 16, work_area_id: 3, description: 'Cell Module Stacking Gripper CSG-8',
  ...
  {
    id: 17, work_area_id: 3, description: 'Battery Pack EOL Charge/Discharge Tester',
  ...
  {
    id: 18, work_area_id: 4, description: 'Vehicle Marriage Station VMS-2000 (Chassis-Body)',
  ...
  {
    id: 19, work_area_id: 4, description: 'Windshield Setting Robot WSR-1 (Fanuc)',
  ...
  {
    id: 20, work_area_id: 4, description: 'Conveyor Transfer System C-12 (Skid-Based)',
  ...
  {
    id: 21, work_area_id: 4, description: 'Door Assembly Jig DAJ-LR (Left + Right)',
  ...
  {
    id: 22, work_area_id: 4, description: 'Fluid Fill Station (Brake + Coolant + AC)',
  ...
  {
    id: 23, work_area_id: 5, description: 'Paint Touch-Up Booth PTB-1 (with extraction)',
  ...
  {
    id: 24, work_area_id: 5, description: 'Diagnostic Laptop Kit DLK-10 (x10)',
  ...
  {
    id: 25, work_area_id: 5, description: 'Headlamp Aim Adjustment Tool HAA-2',
  ...
  {
    id: 26, work_area_id: 5, description: 'Rework Lift Table RLT-500 (x2)',
  ...
  {
    id: 27, work_area_id: 6, description: 'End-of-Line Tester EOL-5000 (Complete System)',
  ...
  {
    id: 28, work_area_id: 6, description: 'Roll Test Dyno Stand RD-200',
    original_amount: 195_000, current_amount: 195_000,
    expected_cash_out: '2026-07', cost_basis: 'initial_supplier_offer', cost_driver: 'process',
  ...
  {
    id: 29, work_area_id: 6, description: 'Wheel Alignment System WAS-3D',
  ...
  {
    id: 30, work_area_id: 6, description: 'HV Isolation Resistance Tester HIT-1000',
  ...
  {
    id: 31, work_area_id: 6, description: 'Vehicle Data Logger & Flash Station VDL-8',
  ...
  {
    id: 32, work_area_id: 7, description: 'Water Ingress Test Chamber IP67',
  ...
  {
    id: 33, work_area_id: 7, description: 'Climate Chamber -40°C to +80°C (Component)',
  ...
  {
    id: 34, work_area_id: 7, description: 'Dust Exposure Test Chamber (IP5X/IP6X)',
  ...
  {
    id: 35, work_area_id: 7, description: 'Salt Spray Corrosion Cabinet SSC-1',
  ...
  {
    id: 36, work_area_id: 8, description: 'NVH Analysis Booth (Semi-Anechoic)',
  ...
  {
    id: 37, work_area_id: 8, description: 'Vibration Shaker System (Electrodynamic)',
  ...
  {
    id: 38, work_area_id: 8, description: 'Acoustic Measurement Kit (B&K Microphones x12)',
  ...
  {
    id: 39, work_area_id: 9, description: 'High-Voltage Leak Detection Unit HVLD-2',
    original_amount: 78_000, current_amount: 78_000,
  ...
  {
    id: 40, work_area_id: 9, description: 'Battery Abuse Test Rig (Nail Pen + Crush)',
  ...
  {
    id: 41, work_area_id: 9, description: 'Partial Discharge Measurement System PDM-1',
  ...
  {
    id: 42, work_area_id: 9, description: 'HV Safety PPE Set & Emergency Shutdown Panel',
  ...
  {
    id: 43, work_area_id: 10, description: 'Goods-In Inspection Station GIS-2 (with scale)',
  ...
  {
    id: 44, work_area_id: 10, description: 'Receiving Area Roller Conveyor RC-6',
    original_amount: 22_000, current_amount: 22_000,
  ...
  {
    id: 45, work_area_id: 10, description: 'Label Printer & Scanning Gateway LSG-1',
  ...
  {
    id: 46, work_area_id: 11, description: 'Vertical Lift Module Kardex-500 (2 units)',
  ...
  {
    id: 47, work_area_id: 11, description: 'Kanban Supermarket Rack System KSR-24',
  ...
  {
    id: 48, work_area_id: 11, description: 'Pallet Racking System (Heavy Duty, 120 bays)',
    original_amount: 62_000, current_amount: 62_000,
    expected_cash_out: '2026-03', cost_basis: 'initial_supplier_offer', cost_driver: 'initial_setup',
  ...
  {
    id: 49, work_area_id: 11, description: 'Returnable Packaging Set (KLT + Pallets)',
    original_amount: 28_000, current_amount: 28_000,
    expected_cash_out: '2026-04', cost_basis: 'cost_estimation', cost_driver: 'initial_setup',
  ...
  {
    id: 50, work_area_id: 12, description: 'AGV Fleet (5 units) — Jungheinrich EZS 350a',
    original_amount: 185_000, current_amount: 185_000,
    expected_cash_out: '2026-07', cost_basis: 'initial_supplier_offer', cost_driver: 'process',
  ...
  {
    id: 51, work_area_id: 12, description: 'Electric Tow Tractor ETT-3 (x2)',
  ...
  {
    id: 52, work_area_id: 12, description: 'Tugger Train Route Markers & Floor Guidance',
  ...
  {
    id: 53, work_area_id: 13, description: 'Packaging Line PL-3 (Stretch Wrap + Strapping)',
  ...
  {
    id: 54, work_area_id: 13, description: 'Shipping Scale & Dimension Scanner SDS-1',
  ...
  {
    id: 55, work_area_id: 13, description: 'Loading Dock Leveler (Hydraulic, 2 docks)',
  ...
  {
    id: 56, work_area_id: 14, description: 'Busbar Power Distribution 400V (Main Hall)',
    original_amount: 165_000, current_amount: 172_000,
    expected_cash_out: '2026-04', cost_basis: 'initial_supplier_offer', cost_driver: 'initial_setup',
  ...
  {
    id: 57, work_area_id: 14, description: 'Transformer Station 20kV/400V (800 kVA)',
    original_amount: 125_000, current_amount: 125_000,
    expected_cash_out: '2026-03', cost_basis: 'initial_supplier_offer', cost_driver: 'initial_setup',
  ...
  {
    id: 58, work_area_id: 14, description: 'UPS System 60 kVA (Testing Area)',
    original_amount: 38_000, current_amount: 38_000,
    expected_cash_out: '2026-05', cost_basis: 'initial_supplier_offer', cost_driver: 'initial_setup',
  ...
  {
    id: 59, work_area_id: 14, description: 'EV Charging Infrastructure (20 AC + 4 DC)',
  ...
  {
    id: 60, work_area_id: 15, description: 'Central HVAC System (Assembly Hall 4000m²)',
    original_amount: 195_000, current_amount: 195_000,
    expected_cash_out: '2026-05', cost_basis: 'initial_supplier_offer', cost_driver: 'initial_setup',
  ...
  {
    id: 61, work_area_id: 15, description: 'Clean Room HVAC (Battery Area, ISO 8)',
  ...
  {
    id: 62, work_area_id: 15, description: 'Fume Extraction System (Welding + Adhesive)',
    original_amount: 42_000, current_amount: 42_000,
    expected_cash_out: '2026-04', cost_basis: 'cost_estimation', cost_driver: 'initial_setup',
  ...
  {
    id: 63, work_area_id: 15, description: 'Compressed Air System 12bar (Atlas Copco GA55)',
    original_amount: 68_000, current_amount: 68_000,
    expected_cash_out: '2026-04', cost_basis: 'initial_supplier_offer', cost_driver: 'initial_setup',
  ...
  {
    id: 64, work_area_id: 16, description: 'Smoke Detection System (Aspirating, Full Hall)',
  ...
  {
    id: 65, work_area_id: 16, description: 'Sprinkler System (Wet Pipe, Battery Storage)',
  ...
  {
    id: 66, work_area_id: 16, description: 'Emergency Lighting & Exit Signage (LED)',
    original_amount: 18_000, current_amount: 18_000,
    expected_cash_out: '2026-03', cost_basis: 'cost_estimation', cost_driver: 'initial_setup',
  ...
  {
    id: 67, work_area_id: 17, description: 'ESD Flooring Hall A (Epoxy, 2500m²)',
    original_amount: 95_000, current_amount: 95_000,
    expected_cash_out: '2026-03', cost_basis: 'initial_supplier_offer', cost_driver: 'initial_setup',
  ...
  {
    id: 68, work_area_id: 17, description: 'LED High-Bay Lighting (Assembly + Logistics)',
  ...
  {
    id: 69, work_area_id: 17, description: 'Foundation Reinforcement (Press Area)',
    original_amount: 42_000, current_amount: 42_000,
    expected_cash_out: '2026-02', cost_basis: 'cost_estimation', cost_driver: 'initial_setup',
  ...
  {
    id: 70, work_area_id: 17, description: 'Crane Installation (5-ton overhead, 25m span)',
    original_amount: 78_000, current_amount: 82_000,
  ...
  {
    id: 71, work_area_id: 18, description: '5-Axis CNC Center DMG Mori CMX 600V',
    original_amount: 185_000, current_amount: 185_000,
    expected_cash_out: '2026-06', cost_basis: 'initial_supplier_offer', cost_driver: 'initial_setup',
  ...
  {
    id: 72, work_area_id: 18, description: 'CNC Lathe (Turning Center) Mazak QT-250',
    original_amount: 95_000, current_amount: 95_000,
  ...
  {
    id: 73, work_area_id: 18, description: 'Workholding & Fixturing Kit (Modular)',
    original_amount: 15_000, current_amount: 15_000,
    expected_cash_out: '2026-04', cost_basis: 'cost_estimation', cost_driver: 'initial_setup',
  ...
  {
    id: 74, work_area_id: 19, description: '3D Printer — EOS M290 Metal (DMLS)',
  ...
  {
    id: 75, work_area_id: 19, description: 'FDM Printer Farm (3x Stratasys F370)',
    original_amount: 42_000, current_amount: 42_000,
    expected_cash_out: '2026-05', cost_basis: 'initial_supplier_offer', cost_driver: 'initial_setup',
  ...
  {
    id: 76, work_area_id: 19, description: 'Post-Processing Station (Bead Blast + Oven)',
    original_amount: 18_000, current_amount: 18_000,
  ...
  {
    id: 77, work_area_id: 20, description: 'Coordinate Measuring Machine (Zeiss Contura)',
    original_amount: 145_000, current_amount: 145_000,
  ...
  {
    id: 78, work_area_id: 20, description: 'Optical 3D Scanner (GOM ATOS Q)',
  ...
  {
    id: 79, work_area_id: 20, description: 'Test Fixture Fabrication Bench TFB-2',
    original_amount: 12_000, current_amount: 12_000,
    expected_cash_out: '2026-04', cost_basis: 'cost_estimation', cost_driver: 'initial_setup',
  ...
  {
    id: 80, work_area_id: 20, description: 'Surface Roughness & Hardness Tester Kit',
    original_amount: 8_500, current_amount: 8_500,
...
function itemsForDept(deptId: number): CostItem[] {
